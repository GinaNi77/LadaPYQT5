...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Работники"))
        ...
        item.setText(_translate("MainWindow", "Дата найма"))

        self.label_0.setText(_translate("MainWindow", "Добавление работника"))
        self.label_0.setFont(QFont('Arial', 14))

        self.label_8.setText(_translate("MainWindow", "Удаление работника"))
