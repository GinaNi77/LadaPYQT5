...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_0.setText(_translate("MainWindow", "Добавление заказа"))
        self.label_0.setFont(QFont('Arial', 14))

        self.label_8.setText(_translate("MainWindow", "Удаление заказа"))
        self.label_8.setFont(QFont('Arial', 14))

        self.label.setText(_translate("MainWindow", "Код клиента"))
        self.label_3.setText(_translate("MainWindow", "Код машины"))
        self.label_4.setText(_translate("MainWindow", "Дата заказа"))
